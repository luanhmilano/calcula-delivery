                ...
                <div className="flex items-center space-x-4">
                    {user ? (
                        <>
                            ...
                            <button onClick={onLogout} className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition text-sm font-medium">Sair</button>
                        </>
                    ) : (
                        <>
                            <button onClick={() => navigateTo('login')} className="text-gray-600 hover:text-green-600 font-medium transition">Login</button>
                            <button onClick={() => navigateTo('cadastro')} className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition font-bold">Cadastre-se</button>
                        </>
                    )}
                </div>
            </div>
