        ...
        <div className="flex min-h-screen bg-gray-100">
            ...
            <main className="flex-1 lg:ml-0 p-4 sm:p-6 lg:p-10">
                <div className="container mx-auto">
                    <button onClick={() => navigateTo('listaPratos')} className="flex items-center gap-2 text-green-600 font-medium mb-6 hover:underline mt-12 lg:mt-0">
                        <ArrowLeft size={18} />
                        Voltar para a Lista de Pratos
                    </button>
                    <div className="mb-6 sm:mb-8">
                        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800">Análise de Cenários</h2>
                        <p className="text-base sm:text-lg text-gray-600 mt-2">Simule o impacto de mudanças no prato: <span className="font-bold text-green-700">{pratoOriginal.nome}</span></p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
                        ...
                        <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-lg lg:sticky lg:top-24">
                            <h3 className="text-lg sm:text-xl font-bold text-gray-700 mb-4">Comparativo: Antes vs. Depois</h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {/* Antes */}
                                <div className="space-y-3">
                                    <h4 className="font-bold text-center text-gray-500 text-sm sm:text-base">Cenário Atual</h4>
                                ...
                                {/* Depois */}
                                <div className="space-y-3">
                                     <h4 className="font-bold text-center text-blue-600 text-sm sm:text-base">Cenário Simulado</h4>
                            ...
                            <button 
                                ...
                                className="w-full mt-6 bg-green-600 text-white py-3 rounded-lg text-base sm:text-lg font-bold hover:bg-green-700 transition flex items-center justify-center gap-2"
                            >
                                <CheckCircle size={20}/>
                                <span className="hidden sm:inline">Aplicar Cenário ao Prato Real</span>
                                <span className="sm:hidden">Aplicar Cenário</span>
                            </button>
                        </div>
                    </div>
                </div>
