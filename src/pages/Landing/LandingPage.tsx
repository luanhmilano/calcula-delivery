    ...
    <main>
      <section className="bg-white py-16 sm:py-24">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-6xl font-extrabold text-gray-800 leading-tight">
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
            <button onClick={() => navigateTo('simuladorTeste')} className="w-full sm:w-auto bg-green-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg text-base sm:text-lg font-bold hover:bg-green-700 transition shadow-lg">
              Calcule seu Preço Agora!
            </button>
            <button onClick={() => navigateTo('cadastro')} className="w-full sm:w-auto bg-gray-200 text-gray-800 px-6 py-3 sm:px-8 sm:py-4 rounded-lg text-base sm:text-lg font-bold hover:bg-gray-300 transition">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
          <div className="container mx-auto px-4">
              <h3 className="text-2xl sm:text-3xl font-bold text-center text-gray-800 mb-12">Como o CalculaDelivery te ajuda?</h3>
