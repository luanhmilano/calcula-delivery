        ...
        <div className="container mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            ...
            <button
              ...
              className="bg-green-600 text-white px-5 py-3 rounded-lg hover:bg-green-700 transition font-bold flex items-center gap-2"
            >
              <PlusCircle size={20} />
              Simular Novo Prato
            </button>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md">
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <select
                ...
                className="w-full sm:w-1/3 px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg"
              >
                {categorias.map((cat) => (
